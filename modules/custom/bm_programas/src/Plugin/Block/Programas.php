...
namespace Drupal\bm_programas\Plugin\Block;
 ...
 * @Block(
 *   id = "programas_block",
 *   admin_label = @Translation("Block Programas - Bimbo Proveedores")
 * )
 */
class Programas extends BlockBase implements ContainerFactoryPluginInterface {
