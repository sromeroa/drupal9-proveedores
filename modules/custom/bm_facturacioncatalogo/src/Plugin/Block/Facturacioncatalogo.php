...
namespace Drupal\bm_facturacioncatalogo\Plugin\Block;
 ...
 *   admin_label = @Translation("Block Facturacion catalogo principal- Bimbo Proveedores")
 * )
 */
class Facturacioncatalogo extends BlockBase implements ContainerFactoryPluginInterface {
  ...
  public function build() {
    ...
    $renderable = [
      '#theme' => 'facturacioncatalogo_template',
      ...
      foreach($content as $val) {
        $response[] =
          [
            ...
            "facturacionId" => (isset($val->nid) && !empty($val->nid)) ? $val->nid : "",
