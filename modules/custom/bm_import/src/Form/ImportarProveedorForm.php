...
/**
 * @file
 * Contains \Drupal\bm_import\Form\ImportarProveedorForm.
 */
...
class ImportarProveedorForm extends FormBase
{
  ...
  {
    return 'importar_proveedor_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state)
  {
    ...
    $form['actions']['submit'] = [
      '#type' => 'submit',
      '#value' => $this->t('Importar Proveedores'),
      '#button_type' => 'primary',
    ];
  ...
  public function submitForm(array &$form, FormStateInterface $form_state)
  {
    ...
    $entity_type = "node";
    $entity_type_bundle = "user_revision";
    ...
    // Reemplazar los valores de texto por las columas correspondientes
    $parser_importer = new ParserImporter();
    $parser_importer->setCSV($csv_parse);
    $parser_importer->setCatalogList($this->catalog_list);
    $new_csv_parse = $parser_importer->getUpdatedCSV();

    $this->importer->createInstance('block_content_importer', [
      //'csv' => $csv_parse,
      'csv' => $new_csv_parse,
